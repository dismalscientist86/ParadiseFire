...
\begin{frame}{Appendix: Homelessness (PIT Counts)}
  \begin{figure}
    \centering
  ...
  \end{figure}
  \vspace{-0.5em}
  \footnotesize \textbf{Note:} Counts rose sharply in 2017, \emph{before} the fire.
  Post-fire levels (1,266--1,381) are only modestly above the 2017 pre-fire level (1,195),
  making a clean causal attribution to the Camp Fire difficult.
\end{frame}

\begin{frame}{Appendix: Homelessness --- Comparison CoCs}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{itemize}
        \item Butte County 2017 (pre-fire): \textbf{1,195}
        \item Butte County 2018 (fire year): \textbf{1,125}
        \item Butte County 2019: \textbf{1,266} (+$12\%$ from 2018)
        \item Butte County 2024: \textbf{1,381} (+$23\%$ from 2018)
        \item Emergency shelter capacity expanded substantially
              (274 $\to$ 641 beds, +134\%), consistent with a
              sustained displacement shock even if aggregate counts
              are noisy
      \end{itemize}
    \end{column}
    \begin{column}{0.43\textwidth}
